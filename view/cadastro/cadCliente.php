...
//update
    if($acaoPost == 2){
        $senhaUser = isset($_POST['idCliente']) ? $_POST['idCliente'] : "" ;
        $objCliente = new Cliente(NULL, $nome, $rg, $cpf, $sexo, $dtNasc, $email,$nomeUser,$senhaUser);
        $objClienteDAO->alterarCliente($conexao, $objCliente);
    }
...
<form method="post" action="index.php?view=cadastro&page=cadcliente">
    ...
    <label>Nome:</label><input required type="text" name="txtNome" luvae="<?php echo$objCliente->getNome();  ?>" /> <br />
