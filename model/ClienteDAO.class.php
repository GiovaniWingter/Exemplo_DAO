...
class ClienteDAO {
    ...
    private static $SELECT_ALL = "select * from cliente where status = 'A' order by nome_cliente  ";
    
    private static $SELECT_ID = "select * from cliente where id_cliente = :id_cliente and status = 'A' ";
    
    private  static $DELETE_ID = "update cliente set 
                                    status = 'I'
                                 where 
        ...
        try{
           ...
           $stmtIns->execute(
                    array(
                        ...
                        ':dtNasc_cliente'=> DataFormatter::dataBrToMySql($obj->getDtNasc()),
